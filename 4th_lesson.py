...
## ※ homework3.py의 '함수Mission'을 풀 때, 참고할 것.(일부 복사 붙여넣기 가능)
'''
import turtle
...
## docstring: 함수에 대한 설명을 나타내는 문장(def 바로 아랫줄에 '''or"""으로 설명을 써 넣는다
